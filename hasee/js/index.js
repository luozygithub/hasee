define(["jquery","jquery-cookie"],function($){
    function index(){
        $(function(){
            ...
            // $('.img-btn li').mouseenter(function(){
            //     clearInterval(Bannertimer);
            // })
            // $('.img-btn li').mouseleave(function(){
            //     BannertimerStart();
            // })
        ...
        $(function(){
            $(document).scroll(function(ev){
                ...
                if($('html,body').scrollTop() > 500){
                    $('.side').stop().fadeIn(800);
                }else{
                    $('.side').stop().fadeOut(1000);
                }
            })
        })
        //side end left nav
            ...
            $.ajax({
                ...
                success:function(data){
                    for(let i = 0; i < data[0].length; i++){
                        if(i<2){
                            $(`<li class="bgcolor1 label_news"><a target="_blank" href="product1.html?id=1">
